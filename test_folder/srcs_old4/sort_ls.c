...
/*   Updated: 2019/10/07 07:11:24 by vzhao            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_ls.h"

static int		timecmp(t_ls_data *a, t_ls_data *b, t_lsflags *flags)
{
	if (flags->u)
...
static t_ls_data	*sorting(t_ls_data *a, t_ls_data *b, t_lsflags *flags)
{
	t_ls_data *ret;
